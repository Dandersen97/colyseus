...
${logBox.content}`;
  ...
  const _originalJoinOrCreate = import_sdk.Client.prototype.joinOrCreate;
  import_sdk.Client.prototype.joinOrCreate = async function() {
    const room = await _originalJoinOrCreate.apply(this, arguments);
    handleClientJoin(room);
    return room;
  };
  const _originalCreate = import_sdk.Client.prototype.create;
  import_sdk.Client.prototype.create = async function() {
    const room = await _originalCreate.apply(this, arguments);
    handleClientJoin(room);
    return room;
  };
  const _originalJoin = import_sdk.Client.prototype.join;
  import_sdk.Client.prototype.join = async function() {
    const room = await _originalJoin.apply(this, arguments);
    handleClientJoin(room);
    return room;
  };
  const _originalJoinById = import_sdk.Client.prototype.joinById;
  import_sdk.Client.prototype.joinById = async function() {
